...
#define SVB_VERSION_SS524V100	0x0003
...
static void get_temperature(int *temperature)
{
	...
	*temperature = (int)((((int)value - 127) * 431) >> 11) - 40;
}
...
static void start_svb(void)
{
	...
	version = (version & 0x0000FFFF) | (SVB_VERSION_SS524V100 << 16);
	writel(version, SVB_VERSION_REG);

	/* open hmp clock */
	writel(0x10, HPM_CLK_REG);
	delay(18);//18
	...
	core_volt_for_training = (unsigned int)((int)core_volt + volt_delta_val - 20);
