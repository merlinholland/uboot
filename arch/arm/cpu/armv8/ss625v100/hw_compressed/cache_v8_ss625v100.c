...
static struct mm_region ss625v100_mem_map[] = {
	{
		.virt = 0x0UL,
		.phys = 0x0UL,
		.size = 0x40000000UL,
...
struct mm_region *mem_map = ss625v100_mem_map;
...
static int pte_type(const u64 *pte)
{
...
static void set_pte_table(u64* const pte, const u64 *table)
{
...
static void add_map(const struct mm_region *map)
{
	u64 *pte = NULL;
	u64 virt = map->virt;
	u64 phys = map->phys;
