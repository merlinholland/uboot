...
static void __arch_pcie0_tst_srst_req_sel(const void *crg_base)
{
...
static void __arch_pcie1_tst_srst_req_sel(const void *crg_base)
{
	unsigned int reg_val;
...
static void __arch_phy1_porta_unreset(void* const crg_base)
{
	unsigned int reg_val;
...
static void __arch_phy1_portb_unreset(void* const crg_base)
{
	unsigned int reg_val;
...
static void __arch_phy2_porta_unreset(void* const crg_base)
{
	unsigned int reg_val;
...
static void __arch_phy2_portb_unreset(void* const crg_base)
{
	unsigned int reg_val;
...
static void __arch_phy1_porta_para_config(void* const misc_base)
{
...
static void __arch_phy1_portb_para_config(void* const misc_base)
{
...
static void __arch_phy2_porta_para_config(void* const misc_base)
{
...
static void __arch_phy2_portb_para_config(void* const misc_base)
{
...
int board_init(void)
{
	...
	gd->bd->bi_arch_number = MACH_TYPE_SS528V100;
