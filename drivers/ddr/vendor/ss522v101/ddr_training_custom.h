...
#define DDR_PHY_S28_V300_CONFIG
...
/* [CUSTOM] DDR PHY0 base register, PHY1: 0x1113e000 */
#define DDR_REG_BASE_PHY0        0x1113c000
/* [CUSTOM] DDR DMC0 base register */
#define DDR_REG_BASE_DMC0        0x11138000
/* [CUSTOM] DDR DMC1 base register */
#define DDR_REG_BASE_DMC1        0x11139000
#ifdef DDR_REG_BASE_PHY1
/* [CUSTOM] DDR DMC2 base register */
#define DDR_REG_BASE_DMC2        0x1113a000
/* [CUSTOM] DDR DMC3 base register */
#define DDR_REG_BASE_DMC3        0x1113b000
#endif
/* [CUSTOM] DDR DDRT base register, ddrt1:0x1ff30000 */
#define DDR_REG_BASE_DDRT        0x11140000
/* [CUSTOM] DDR training item system control */
#define DDR_REG_BASE_SYSCTRL     0x11020000
#define DDR_REG_BASE_AXI         0x11130000
...
void ddr_training_save_reg_custom(const void *relate_reg, unsigned int mask);
void ddr_training_restore_reg_custom(const void *relate_reg);
