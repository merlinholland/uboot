					...
					unsigned char *buf)
{
...
#if (defined CONFIG_TARGET_SS101V500) || (defined CONFIG_TARGET_SS101V300) || \
	(defined CONFIG_TARGET_SS101V200) || (defined CONFIG_TARGET_SS101V600) || \
	...
	sec_boot_mode = readl(REG_BASE_SCTL + REG_SYSSTAT);
#elif (defined CONFIG_TARGET_SS928V100) || (defined CONFIG_TARGET_SS927V100)
	sec_boot_mode = readl(OTP_USER_LOCKABLE14);
#else
	sec_boot_mode = readl(REG_BASE_SCTL + REG_PERISTAT);
#endif

#if (defined CONFIG_TARGET_SS928V100) || (defined CONFIG_TARGET_SS927V100)
	sec_boot_mode = get_sec_boot_mode(sec_boot_mode);
#else
	sec_boot_mode &= SEC_BOOT_MODE;
#endif
